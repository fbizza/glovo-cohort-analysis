...
from utils import retention_since_given_period, clip_dataframes_to_smallest
...
if __name__ == "__main__":
    acquisition_start_date = '2023-06-01'
    acquisition_end_date = '2024-10-01'
    retention_start_date = acquisition_end_date
    retention_end_date = '2024-10-01'
    ...
    customers_dfs = clip_dataframes_to_smallest(customers_dfs)
